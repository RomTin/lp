/****************************************************************************
  テスト２７： checkParamList() の異常ケースのテスト６
  (1) addProcedure() を呼び出して、globalSymTable に引数をもつ手続きの
      エントリを登録する。
  (3) checkParamList() に、引数個数は同じだが真ん中の引数の型が違う引数リストを
